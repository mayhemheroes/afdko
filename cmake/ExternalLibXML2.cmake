...
set(LIBXML2_STATIC_LIBRARY ${CMAKE_CURRENT_BINARY_DIR}/${LIBXML2_TARGET}/src/external.libxml2-build/Release/libxml2.lib)
set(LIBXML2_RUNTIME_LIBRARY ${CMAKE_CURRENT_BINARY_DIR}/${LIBXML2_TARGET}/src/external.libxml2-build/Release/libxml2.dll)
...
ExternalProject_Add(${LIBXML2_TARGET}
  ...
  CONFIGURE_COMMAND cmake -S ${CMAKE_CURRENT_BINARY_DIR}/${LIBXML2_TARGET}/src/${LIBXML2_TARGET} -B ${CMAKE_CURRENT_BINARY_DIR}/${LIBXML2_TARGET}/src/${LIBXML2_TARGET}-build -D LIBXML2_WITH_ICONV=OFF -D LIBXML2_WITH_LZMA=OFF -D LIBXML2_WITH_ZLIB=OFF -D LIBXML2_WITH_PYTHON=OFF -D CMAKE_BUILD_TYPE=Release
  BYPRODUCTS ${LIBXML2_STATIC_LIBRARY} ${LIBXML2_RUNTIME_LIBRARY}
  BUILD_COMMAND cmake --build ${CMAKE_CURRENT_BINARY_DIR}/${LIBXML2_TARGET}/src/${LIBXML2_TARGET}-build --config Release
  # INSTALL_COMMAND ""
  INSTALL_COMMAND cmake --install ${CMAKE_CURRENT_BINARY_DIR}/${LIBXML2_TARGET}/src/${LIBXML2_TARGET}-build
